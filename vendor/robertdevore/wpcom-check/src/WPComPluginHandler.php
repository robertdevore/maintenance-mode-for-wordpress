...
class WPComPluginHandler {
    ...
    public function __construct( string $pluginSlug, string $learnMoreLink ) {
        ...
        register_activation_hook( plugin_basename( $pluginSlug ), [ $this, 'activationCheck' ] );
        register_deactivation_hook( plugin_basename( $pluginSlug ), [ $this, 'setDeactivationFlag' ] );
    }
